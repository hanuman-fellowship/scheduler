...
<?php echo $form->create('Time');?>
	<fieldset>
 		<legend><?php __('Edit Time');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action' => 'delete', $form->value('Time.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Time.id'))); ?></li>
