...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $html->link(__('View', true), array('action' => 'view', $time['Time']['id'])); ?>
			<?php echo $html->link(__('Edit', true), array('action' => 'edit', $time['Time']['id'])); ?>
			<?php echo $html->link(__('Delete', true), array('action' => 'delete', $time['Time']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $time['Time']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
